...
**用一个无返回值的递归函数，单纯起到遍历递归树，在遍历的过程中收集结果，到叶子结点完成结果收集。**
...
**思维框架：**分解问题的思维模式。自底向上的后序递归分解原问题的思维模式。
...
**清晰递归函数的定义是什么，利用这个定义来分解问题，利用子问题的答案推导原问题的答案！**
