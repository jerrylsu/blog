...
![data_eda1](images/data_eda1.jpg)

统计原始会话（连续QQAA未合并）轮数长度以及单句文本长度（按字）。

![data_eda2](images/data_eda2.jpg)

### 数据预处理

![data_preprocess](images/data_preprocess.jpg)

### 训练数据构造

![training_data1](images/training_data1.jpg)

![training_data2](images/training_data2.jpg)

### 融合多模态与知识库

![data_fusion](images/data_fusion.jpg)
...
![mhred](images/baseline_mhred.jpg)

### 最佳模型VLGPT

![vlgpt](images/best_vlgpt.jpg)
